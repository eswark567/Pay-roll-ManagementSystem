...
cur.execute(f"create table Attendence(Eid int,Ename varchar(40),DeptId int, DeptName varchar(20),Date datetime,time_in datetime,time_out datetime,FOREIGN KEY (Eid) REFERENCES Employee_Details,FOREIGN KEY (DeptId) REFERENCES Salary(DeptId))")
conn.commit()
conn.close()
